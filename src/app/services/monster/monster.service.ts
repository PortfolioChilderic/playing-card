...
export class MonsterService {
    ...
    private init() {
        ...
        monster2.name = "Car";
        monster2.image = "Monster/Water.png"
        ...
        monster3.name = "Bulb";
        monster3.image = "Monster/Plant.png"
        ...
        monster4.name = "Sala";
        monster4.image = "Monster/Fire.png"
    ...
    delete(monsterId: number) {
        const monsterIndex = this.monsters.findIndex(originalMonster => originalMonster.id === monsterId)
        if (monsterIndex != -1) {
